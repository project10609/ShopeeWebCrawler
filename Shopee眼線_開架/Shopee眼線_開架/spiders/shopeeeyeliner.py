...
class ShopeeeyelinerSpider(scrapy.Spider):
    name = 'shopeeeyeliner'

    start_urls = ['https://shopee.tw/search?category=67&facet=15741&keyword=%E7%9C%BC%E7%B7%9A&page=0&subcategory=15730']
    ...
    def parse(self, response):
        ...
        next_page = 'https://shopee.tw/search?category=67&facet=15741&keyword=%E7%9C%BC%E7%B7%9A&page=0&subcategory=15730&page=' + str(
            ShopeeeyelinerSpider.page)
