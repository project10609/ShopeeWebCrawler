...
class ShopeeremoveSpider(scrapy.Spider):
    name = 'shopeeremove'
    start_urls = ['https://shopee.tw/search?category=67&facet=15602&keyword=%E5%8D%B8%E5%A6%9D&page=0&subcategory=15401']
    ...
    def parse(self, response):
        ...
        next_page = 'https://shopee.tw/search?category=67&facet=15602&keyword=%E5%8D%B8%E5%A6%9D&page=0&subcategory=15401&page=' + str(
            ShopeeremoveSpider.page)
        ...
        if ShopeeremoveSpider.page <= 100:
            ShopeeremoveSpider.page += 1
            url = next_page
