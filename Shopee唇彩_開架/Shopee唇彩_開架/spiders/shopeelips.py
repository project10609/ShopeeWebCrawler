...
class ShopeelipsSpider(scrapy.Spider):
    name = 'shopeelips'
    start_urls = ['https://shopee.tw/search?category=67&keyword=%E5%94%87%E5%BD%A9%E9%A1%9E%E7%94%A2%E5%93%81&subcategory=15730']
    page = 1
    ...
    def parse(self, response):
        ...
        next_page = 'https://shopee.tw/search?category=67&keyword=%E5%94%87%E5%BD%A9%E9%A1%9E%E7%94%A2%E5%93%81&subcategory=15730&page=' + str(
            ShopeelipsSpider.page)
        ...
        if ShopeelipsSpider.page <= 100:
            ShopeelipsSpider.page += 1
            url = next_page
